...
public class ToStringIncludeFieldNameDemo {
    ...
    public java.lang.String toString() {
        return "ToStringIncludeFieldNameDemo(demoInt=" + this.demoInt + ", demoString=" + this.demoString + ", demoList=" + this.demoList + ", demoArray=" + java.util.Arrays.deepToString(this.demoArray) + ")";
    }
}
