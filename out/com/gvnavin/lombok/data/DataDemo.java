...
public class DataDemo {
    ...
    public DataDemo(final String demoFinalString) {
    ...
    public java.lang.String toString() {
        return "DataDemo(demoInt=" + this.getDemoInt() + ", demoString=" + this.getDemoString() + ", demoList=" + this.getDemoList() + ", demoArray=" + java.util.Arrays.deepToString(this.getDemoArray()) + ", demoBoolean=" + this.isDemoBoolean() + ", demoFinalString=" + this.getDemoFinalString() + ")";
    }
}
